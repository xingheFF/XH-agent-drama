...
export const GEOMETRY_PRIMITIVE_OPTIONS = [
  ...
  { type: "door", label: "门" },
  { type: "window", label: "窗户" },
  { type: "stairs", label: "楼梯" },
  { type: "wall", label: "墙体" },
  { type: "streetlight", label: "路灯" },
  { type: "cup", label: "杯子" },
  { type: "bottle", label: "瓶子" },
  { type: "book", label: "书本" },
  { type: "umbrella", label: "雨伞" },
  { type: "potted-plant", label: "盆栽" },
  { type: "fence", label: "围栏" },
  { type: "signboard", label: "标志牌" },
] as const;
