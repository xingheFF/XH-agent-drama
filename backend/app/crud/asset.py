...
def create_asset(db: Session, asset_in: AssetCreate, file_path: str, file_url: str, mime_type: str = None, file_size: int = None) -> Asset:
    asset = Asset(
...
def get_assets(db: Session, user_id: str = None, canvas_id: uuid.UUID = None, asset_type: AssetType = None, query: str = None, skip: int = 0, limit: int = 50) -> List[Asset]:
    q = db.query(Asset)
    if user_id:
